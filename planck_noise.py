...
modes = ['scipy'] # select the likelihood function
PLANCK = True
...
L, cl = likelihood(planck_chains[0], noise, 'scipy')

fake_planck = np.loadtxt('montypython_fake_planck_data.txt')

axes[0, 0].plot(fake_planck[:, 0], fake_planck[:, 1]*(fake_planck[:, 0]*(fake_planck[:, 0]+1)), label='montypython')
axes[0, 0].plot(l_real, cl, label='obs')
axes[0, 0].plot(l_real, p, label='planck')
axes[0, 0].plot(l_real, noise, label='noise')
axes[1, 0].plot(l_real, cl-p, label='residuals')
axes[1, 0].plot(l_real, noise, label='noise')
axes[0, 0].legend()
axes[1, 0].legend()

axes[0, 1].plot(l_real, cl-noise, label='obs')
axes[0, 1].plot(l_real, p, label='planck')
axes[0, 1].plot(l_real, noise, label='noise')
axes[1, 1].plot(l_real, cl-p-noise, label='residuals')
axes[1, 1].plot(l_real, noise, label='noise')
axes[0, 1].legend()
axes[1, 1].legend()
